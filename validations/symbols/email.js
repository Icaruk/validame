...
exports.email = (stringParaValidar, config) => {
	...
	if (empiezaMal) return config.symbols.email.messages.invalid[config.language] + "1";
	...
	if (tieneCaracteres) return config.symbols.email.messages.invalid[config.language] + "2";
